...
- Смоук e2e тесты перенесены в отдельный общий этап и пока не покрыты. Приготовить сценарии «редирект без сессии» и «регистрация → логин → профиль» вместе с будущими end-to-end.
