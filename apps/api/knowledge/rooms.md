...
6. **Получение статуса**
   - GET `/api/rooms/{room_id}` возвращает текущий статус, участников, таймстемпы. Доступ открыт инициатору и приглашённому другу даже до фактического подключения, остальные получают 403.
